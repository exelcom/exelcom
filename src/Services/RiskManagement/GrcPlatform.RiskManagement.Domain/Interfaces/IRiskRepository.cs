...
public interface IRiskRepository
{
    ...
    Task<PagedResult<Risk>> GetPagedAsync(int page, int pageSize, RiskStatus? status = null, RiskCategory? category = null, string? owner = null, CancellationToken cancellationToken = default);
