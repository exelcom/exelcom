...
param(
    ...
    [string]$AppServiceName = "app-compliance-grc-exelcom-dev",
    [string]$ProjectPath    = "src\Services\ComplianceTracking\GrcPlatform.ComplianceTracking.API\GrcPlatform.ComplianceTracking.API.csproj",
    [string]$PublishDir     = "publish\compliance"
)
...
$ZipPath = "publish\compliance.zip"
